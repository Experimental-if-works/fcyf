//var root = 'https://eventos.fisica.unam.mx/events/'+event_id+'.json';
var root2 = 'https://eventos.fisica.unam.mx/events/441.json';
document.write("<br>clave: "+root2+" - valor: ");
...
$.ajax({
  ...
  document.getElementById('event').innerHTML += data.id;
  console.log(data);
