...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-heading text-uppercase"><?php echo $main_title;?></div>
                <div class="masthead-subheading text-uppercase"><?php echo $main_subtitle;?></div>
            </div>
        </header>
        <!-- Next Events-->
        <section class="page-section" id="next_events">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase"><img class="img-fluid img-icons" src="assets/icons/calendario.png" alt="<?php echo $next_event_title;?>" /> <?php echo $next_event_title;?></h2>
                </div>
                <div class="row justify-content-center" id="seminars">
                </div>
            </div>
        </section>
        <hr></hr>
        ...
        <script src="assets/js/data/seminars.js"></script> 
        <script>
